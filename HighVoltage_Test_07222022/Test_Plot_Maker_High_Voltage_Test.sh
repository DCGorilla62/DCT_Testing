...
python Test_High_Voltage_Test_Plot.py raw_data/Supply_1_Load_26M_Ohm.csv raw_data/small_load_HVsupply1_07022022_clean.txt

python Test_High_Voltage_Test_Plot.py raw_data/Supply_1_Load_36M_Ohm.csv raw_data/large_load_HVsupply1_07022022_clean.txt

python Test_High_Voltage_Test_Plot.py raw_data/Supply_2_Load_36M_Ohm.csv raw_data/large_load_HVsupply2_07022022_clean.txt

python Test_High_Voltage_Test_Plot.py raw_data/Supply_2_Load_None.csv raw_data/no_load_HVsupply2_07022022_clean.txt
